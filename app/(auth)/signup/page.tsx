...
import WelcomeFrontImg from "public/images/newAuth/signUp-front-img.png";
  ...
  return (
    <div className="flex flex-wrap md:flex-nowrap bg-white">
      ...
      <div className="w-full xl:w-1/2 px-4 pt-5 xl:px-20 xl:pt-20 pb-10">
        ...
        <div className="flex items-center  max-w-[560px] mx-auto xl:ml-0 justify-center mt-[30px]">
