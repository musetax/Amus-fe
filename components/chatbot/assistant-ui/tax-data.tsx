      ...
      <div className="bg-white rounded-2xl p-6 w-full max-w-2xl relative">
        ...
        <div className="bg-gray-100 p-4 rounded-xl space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <input
              ...
              placeholder="Start Pay Date"
              value={formData.start_pay_date_dt}
              onChange={handleChange}
              className="p-3 rounded-lg bg-white"
            />
          </div>
          ...
          <label className="block">
            ...
            <input
              ...
              value={formData.most_recent_pay_date_dt}
              onChange={handleChange}
              className="w-full mt-2 p-3 rounded-lg bg-white"
            />
          </label>
        </div>
        ...
        <div className="mt-4 space-y-4">
          ...
          <input
            type="text"
            name="withholdingYTD"
            placeholder="Withholding YTD"
            value={formData.withholdingYTD}
            onChange={handleChange}
            className="w-full p-3 rounded-lg bg-gray-100"
          />
          <input
            ...
            placeholder="Withholding on Last Paycheck"
            value={formData.lastPaycheckWithholding}
            onChange={handleChange}
            className="w-full p-3 rounded-lg bg-gray-100"
          />
        </div>
